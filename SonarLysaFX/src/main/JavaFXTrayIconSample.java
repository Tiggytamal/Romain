...
public class JavaFXTrayIconSample extends Application
{
	...
	private void addAppToTray()
	{
		try
		{
			...
			TrayIcon trayIcon = new TrayIcon(Toolkit.getDefaultToolkit().createImage("d:\\SONAR16.jpg"));
			...
			notificationTimer.schedule(new TimerTask() {
				...
				public void run()
				{
					SwingUtilities.invokeLater(
					        () -> trayIcon.displayMessage("hello", "The time is now " + timeFormat.format(new Date()), java.awt.TrayIcon.MessageType.INFO));
				}
			}, 5_000, 60_000);
